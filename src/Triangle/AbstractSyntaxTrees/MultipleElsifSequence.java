 ...
 */
public class MultipleElsifSequence extends ElsifSequence {
     ...
     */
    public MultipleElsifSequence (Elsif elsifAST, ElsifSequence sequenceAST,
                                   SourcePosition pos) {
        super (pos);
        E = elsifAST;
        ES = sequenceAST;
    ...
    public Object visit(Visitor v, Object o) {
        return v.visitMultipleElsifSequence(this, o);
    }
